...
# $Revision: 2346 $
# $Author: geoffc $
# $HeadURL: https://svn.ssec.wisc.edu/repos/jpss_adl/trunk/util/CSPP/IAPP/iapp/iapp_before_and_after_time.csh $
# $Id: iapp_before_and_after_time.csh 2346 2015-02-05 20:35:32Z geoffc $
#
#------------------------------------------------------------------------------

# Check number of arguments
if ($#argv != 3) then
  echo "Usage: iapp_before_and_after_time.csh date time increment"
  echo "where"
